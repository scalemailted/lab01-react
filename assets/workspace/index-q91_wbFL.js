import { g as C, _ as E, n as F, b as z, c as q, e as g, f as M, a as x, h as W, j as D, d as P, S as N, k as A } from "./main-Dsp6Yxj5.js";
import { S as $ } from "./base-80a1f760-CF0Vzd51.js";
const B = {
...
var G = (
  ...
  (function() {
    ...
    return r.prototype.cleanup = function() {
      ...
      this.frameWindow && this.frameWindow.postMessage(x({ $id: this.channelId, codesandbox: !0 }, o), this.origin);
      ...
      return this.globalListeners[n] = o, this.globalListenersCount++, function() {
      ...
      return this.channelListeners[n] = o, this.channelListenersCount++, function() {
...
), R = /* @__PURE__ */ new Map(), K = Object.entries(X);
for (var k = 0, T = K; k < T.length; k++) {
  var O = T[k], Q = O[0], S = O[1];
  if (S.extensions) {
    var _ = S.extensions;
    if (_.length)
...
var Z = R, f = "$CSB_RELAY", aa = 50;
function ea(r, o) {
  if (!r)
    return "static";
  var e = r.dependencies, n = e === void 0 ? {} : e, s = r.devDependencies, a = s === void 0 ? {} : s, i = g(g([], Object.keys(n), !0), Object.keys(a), !0), c = Object.keys(o), p = ["@adonisjs/framework", "@adonisjs/core"];
  ...
  if (i.some(function(t) {
    ...
    return "apollo";
  if (i.indexOf("mdx-deck") > -1)
    return "mdx-deck";
  if (i.indexOf("gridsome") > -1)
    return "gridsome";
  if (i.indexOf("vuepress") > -1)
    return "vuepress";
  if (i.indexOf("ember-cli") > -1)
    return "ember";
  if (i.indexOf("sapper") > -1)
    return "sapper";
  if (i.indexOf("gatsby") > -1)
    return "gatsby";
  if (i.indexOf("quasar") > -1)
    return "quasar";
  if (i.indexOf("@docusaurus/core") > -1)
    return "docusaurus";
  if (i.indexOf("remix") > -1)
    return "remix";
  if (i.indexOf("astro") > -1)
    return "node";
  ...
  if (i.indexOf("@nestjs/core") > -1 || i.indexOf("@nestjs/common") > -1)
    return "nest";
  if (i.indexOf("react-styleguidist") > -1)
    return "styleguidist";
  if (i.indexOf("react-scripts") > -1)
    return "create-react-app";
  if (i.indexOf("react-scripts-ts") > -1)
    return "create-react-app-typescript";
  if (i.indexOf("@angular/core") > -1)
    return "angular-cli";
  if (i.indexOf("preact-cli") > -1)
    return "preact-cli";
  if (i.indexOf("@sveltech/routify") > -1 || i.indexOf("@roxi/routify") > -1 || i.indexOf("vite") > -1 || i.indexOf("@frontity/core") > -1)
    return "node";
  if (i.indexOf("svelte") > -1)
    return "svelte";
  if (i.indexOf("vue") > -1)
    return "vue-cli";
  if (i.indexOf("cx") > -1)
...
var y, L = "-{{suffix}}", na = "https://".concat((y = "2.19.8") === null || y === void 0 ? void 0 : y.replace(/\./g, "-")).concat(L, "-sandpack.codesandbox.io/"), ca = (
  /** @class */
  (function(r) {
    E(o, r);
    function o(e, n, s) {
      ...
      if (a.getTranspilerContext = function() {
        ...
        F(i, "The element '".concat(e, "' was not found")), a.element = i, a.iframe = document.createElement("iframe"), a.initializeElement();
      } else
        a.element = e, a.iframe = e;
      return a.iframe.getAttribute("sandbox") || (a.iframe.setAttribute("sandbox", "allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts allow-downloads allow-pointer-lock"), a.iframe.setAttribute("allow", "accelerometer; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi; clipboard-read; clipboard-write; xr-spatial-tracking;")), a.setLocationURLIntoIFrame(), a.iframeProtocol = new Y(a.iframe, a.bundlerURL), a.unsubscribeGlobalListener = a.iframeProtocol.globalListen(function(c) {
        c.type !== "initialized" || !a.iframe.contentWindow || (a.iframeProtocol.register(), a.options.fileResolver && (a.fileResolverProtocol = new G("fs", function(p) {
        ...
        switch (c.type) {
          ...
          case "action": {
            c.action === "show-error" && (a.errors = g(g([], a.errors, !0), [M(c)], !1));
            break;
          }
          case "done": {
            a.status = "done";
    ...
    return o.prototype.createBundlerURL = function() {
      var e, n = this.options.bundlerURL || na;
      ...
      if (this.options.teamId && (n = n.replace("https://", "https://" + this.options.teamId + "-") + "?cache=".concat(Date.now())), this.options.experimental_enableServiceWorker) {
        var s = [];
        s.push(Math.random().toString(36).slice(4)), n = n.replace(L, "-".concat((e = this.options.experimental_stableServiceWorkerId) !== null && e !== void 0 ? e : s.join("-")));
      } else
        n = n.replace(L, "");
      return n;
    }, o.prototype.serviceWorkerHandshake = function() {
      var e = this, n = new MessageChannel(), s = this.iframe.contentWindow;
      if (!s)
        ...
        return q(this, function(b) {
          switch (b.label) {
            ...
            case 2:
              ...
              b.label = 3;
            case 3:
              return u = p.code, i["Content-Type"] || (v = ia(a), d = Z.get(v), d && (i["Content-Type"] = d)), m = {
                $channel: f,
                $type: "preview/response",
                id: e.id,
                headers: i,
      ...
      W(this.options, e) || (this.options = e, this.updateSandbox());
    }, o.prototype.updateSandbox = function(e, n) {
      var s, a, i, c;
      e === void 0 && (e = this.sandboxSetup), this.sandboxSetup = x(x({}, this.sandboxSetup), e);
      var p = this.getFiles(), l = Object.keys(p).reduce(function(d, m) {
        var t;
        return x(x({}, d), (t = {}, t[m] = {
          code: p[m].code,
          path: m
        }, t));
      }, {}), u = JSON.parse(D(this.sandboxSetup.dependencies, this.sandboxSetup.devDependencies, this.sandboxSetup.entry));
      try {
        u = JSON.parse(p["/package.json"].code);
      } catch (d) {
        console.error(P("could not parse package.json file: " + d.message));
      }
      ...
      this.dispatch(x(x({}, this.options), { type: "compile", codesandbox: !0, version: 3, isInitializationCompile: n, modules: l, reactDevTools: this.options.reactDevTools, externalResources: this.options.externalResources || [], hasFileResolver: !!this.options.fileResolver, disableDependencyPreprocessing: this.sandboxSetup.disableDependencyPreprocessing, experimental_enableServiceWorker: this.options.experimental_enableServiceWorker, template: this.sandboxSetup.template || ea(u, v), showOpenInCodeSandbox: (s = this.options.showOpenInCodeSandbox) !== null && s !== void 0 ? s : !0, showErrorScreen: (a = this.options.showErrorScreen) !== null && a !== void 0 ? a : !0, showLoadingScreen: (i = this.options.showLoadingScreen) !== null && i !== void 0 ? i : !1, skipEval: this.options.skipEval || !1, clearConsoleDisabled: !this.options.clearConsoleOnFirstCompile, logLevel: (c = this.options.logLevel) !== null && c !== void 0 ? c : N.Info, customNpmRegistries: this.options.customNpmRegistries, teamId: this.options.teamId, sandboxId: this.options.sandboxId }));
      ...
      var e = this.getFiles(), n = Object.keys(e).reduce(function(s, a) {
        var i;
      ...
      return e.files["/package.json"] === void 0 ? A(e.files, e.dependencies, e.devDependencies, e.entry) : this.sandboxSetup.files;
    }, o.prototype.initializeElement = function() {
      this.iframe.style.border = "0", this.iframe.style.width = this.options.width || "100%", this.iframe.style.height = this.options.height || "100%", this.iframe.style.overflow = "hidden", F(this.element.parentNode, "The given iframe does not have a parent."), this.element.parentNode.replaceChild(this.iframe, this.element);
    }, o;
  })($)
);
export {
  ca as SandpackRuntime
};
