...
import { _ as oe, a as A, b as E, c as P, d as X, n as N } from "./main-Cmegt408.js";
import { S as ae } from "./base-80a1f760-Bew4tRV8.js";
import { g as ce, E as de, a as G, r as U, f as le, w as W, b as ue, c as he } from "./consoleHook-59e792cb-BVofdDgx.js";
var fe = Object.create, q = Object.defineProperty, pe = Object.getOwnPropertyDescriptor, Q = Object.getOwnPropertyNames, me = Object.getPrototypeOf, ve = Object.prototype.hasOwnProperty, we = (e, r, t) => r in e ? q(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[r] = t, b = (e, r) => function() {
  ...
  if (r && typeof r == "object" || typeof r == "function")
    for (let s of Q(r))
      !ve.call(e, s) && s !== t && q(e, s, { get: () => r[s], enumerable: !(n = pe(r, s)) || n.enumerable });
  return e;
}, O = (e, r, t) => (t = e != null ? fe(me(e)) : {}, ge(
  !e || !e.__esModule ? q(t, "default", { value: e, enumerable: !0 }) : t,
  e
)), ye = (e, r, t) => (we(e, r + "", t), t), H = (e, r, t) => {
  if (!r.has(e))
    throw TypeError("Cannot " + t);
}, y = (e, r, t) => (H(e, r, "read from private field"), t ? t.call(e) : r.get(e)), j = (e, r, t) => {
  if (r.has(e))
    throw TypeError("Cannot add the same private member more than once");
  r instanceof WeakSet ? r.add(e) : r.set(e, t);
}, C = (e, r, t, n) => (H(e, r, "write to private field"), r.set(e, t), t), _ = (e, r, t) => (H(e, r, "access private method"), t), Z = b({
  ...
  "../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/lib/fingerprint.browser.js"(e, r) {
    var t = Z(), n = typeof window == "object" ? window : self, s = Object.keys(n).length, i = navigator.mimeTypes ? navigator.mimeTypes.length : 0, o = t((i + navigator.userAgent.length).toString(36) + s.toString(36), 4);
    r.exports = function() {
      return o;
    };
  }
  ...
  "../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/index.js"(e, r) {
    var t = _e(), n = Z(), s = Ee(), i = 0, o = 4, a = 36, c = Math.pow(a, o);
    function l() {
  ...
  "../../node_modules/.pnpm/@open-draft+deferred-promise@2.1.0/node_modules/@open-draft/deferred-promise/build/DeferredPromise.js"(e) {
    ...
    var r = te(), t = (o = class extends Promise {
      constructor(c = null) {
  ...
  "../../node_modules/.pnpm/@open-draft+deferred-promise@2.1.0/node_modules/@open-draft/deferred-promise/build/index.js"(e) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }), t(te(), e), t(Pe(), e);
  }
}), re = b({
  ...
  "../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/Emitter.js"(e) {
    ...
    var r = re(), t, n, s, i, o, a, c, l, h, f, v, w = class {
      constructor() {
        j(this, i), j(this, a), j(this, l), j(this, f), j(this, t, void 0), j(this, n, void 0), j(this, s, void 0), C(this, t, /* @__PURE__ */ new Map()), C(this, n, w.defaultMaxListeners), C(this, s, !1);
      }
  ...
  "../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/index.js"(e) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }), t(be(), e), t(re(), e);
  }
}), Le = O(ee()), Ie = /(%?)(%([sdjo]))/g;
function Me(e, r) {
  switch (r) {
...
var B = O($()), Ce = window.localStorage.CSB_EMULATOR_DEBUG, Fe = "\x1B[0m", Ae = "\x1B[32;1m", xe = "\x1B[31m", De = "\x1B[34m", Te = "\x1B[33;1m", Re = "\x1B[35;1m", J = "\x1B[36;1m", Ue = {
  preview: Te,
  emulator: Re,
  runtime: J,
  bridge: De,
...
function ne(e) {
  return function(t, ...n) {
    if (Ce === "true") {
      const s = () => t.includes("sender") ? `${Ae}sender` : t.includes("receiver") ? `${xe}receiver` : "", i = t.replace(/\[.+\]:/, "");
      console.debug(`${Ue[e]}${e}:${s()}${Fe}:${i}`, ...n);
    }
  };
}
var I = ne("emulator"), We = class {
  constructor(e) {
    p(this, "emitter");
    p(this, "channel");
    p(this, "receiverPort");
  ...
  async send(e, ...r) {
    const t = new B.DeferredPromise(), n = (0, Le.default)(), s = r[0] || {};
  ...
  async waitFor(e, r, t = Ve) {
    const n = new $e.DeferredPromise(), s = setTimeout(() => {
      n.reject();
...
}, Ge = "https://nodebox-runtime.codesandbox.io", x = ne("emulator"), Je = class {
  constructor(e) {
    p(this, "channel", null);
    p(this, "isConnected");
    p(this, "url");
    ...
    this.options = e, L(
      ...
      this.options.iframe
    ), this.url = this.options.runtimeUrl || Ge, this.isConnected = !1;
  }
  async connect() {
    ...
    ), this.channel = new We(e.contentWindow);
  ...
  get fs() {
    ...
    ), this.fileSystemApi ? this.fileSystemApi : (this.fileSystemApi = new Ne(this.channel), this.fileSystemApi);
  }
  get shell() {
    return L(
      this.isConnected,
      'Failed to access the Shell API: consumer is not connected. Did you forget to run "connect()"?'
    ), this.shellApi ? this.shellApi : (this.shellApi = new qe(this.channel), this.shellApi);
  }
  get preview() {
    return L(
      this.isConnected,
      'Failed to access the Preview API: consumer is not connected. Did you forget to run "connect()"?'
    ), this.previewApi ? this.previewApi : (this.previewApi = new ze(this.channel), this.previewApi);
  }
}, Ye = "INJECT_AND_INVOKE", Ke = "PREVIEW_LOADED";
function Xe(e, r) {
...
var tt = [
  { code: Ze.toString(), id: "historyListener" },
  {
    code: "function consoleHook({ scope }) {" + he + `
};`,
    id: "consoleHook"
  },
  { code: et.toString(), id: "watchResize" }
], rt = function(e, r) {
  ...
  (function(e) {
    ...
    function r(t, n, s) {
      ...
      return i._modulesCache = /* @__PURE__ */ new Map(), i.messageChannelId = ce(), i._initPromise = null, i.emitter = new de(), i.manageIframes(t), i.emulator = new Je({
    ...
    return r.prototype._init = function(t) {
      ...
      return E(this, void 0, void 0, function() {
        ...
        return P(this, function(o) {
          switch (o.label) {
            case 0:
              return n = U(t["/package.json"]), this.emulatorCommand = le(n), this.emulatorShellProcess = this.emulator.shell.create(), [4, this.emulatorShellProcess.on("exit", function(a) {
                i.dispatch({
                  type: "action",
                  action: "notification",
                  notificationType: "error",
